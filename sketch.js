...
//             //covid 19
            ...
            text("Recoverd:  "+recover,width/10,height/1.17);
            ...
            textSize(30);
            textStyle("bold")
            text("Coordinates",width/1.75,height/3.2)
            ...
            textStyle(NORMAL)
            textSize(20)
            text("°C",width/1.95,height/6.2)
            text("Latitude:",width/1.8,height/2.7)
            text("Longitude:",width/1.8,height/2.35)
            text("Wind Speed:",width/1.8,height/1.8)
            text("Wind Direction:",width/1.8,height/1.65)
            fill("black")
            text("("+country1+")",width/1.5,height/1.43)
            fill("#ffffff")
...
noStroke();
            ...
            text(Math.round(windSpeed)+` Kph`,width/1.15,height/1.8)
            text(Math.round(windD)+`°`,width/1.15,height/1.65)
